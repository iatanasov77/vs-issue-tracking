...
$( function ()
{
    ...
    $( '.btnCreateTask' ).on( 'click', function( e )
    {
        ...
        var createTaskUrl =  VsPath( 'vs_issue_tracking_project_issues_kanbanboard_pipeline_get_task_form', {
        ...
        $.ajax({
            ...
            success: function( response )
            {
                ...
                $( '#createTaskModal' ).removeAttr( "tabindex" );
            },
            error: function()
            {
                alert( "SYSTEM ERROR!!!" );
    ...
    $( '#modalPipelineTask' ).on( 'submit', '#btnCreateIssueForm', function( e )
    {
        ...
        $.ajax({
            ...
            success: function( response )
            {
                ...
                var taskUrl = VsPath( 'vs_issue_tracking_project_issues_kanbanboard_pipeline_get_task_form', {
