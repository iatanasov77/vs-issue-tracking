...
$( function ()
{
    ...
    $( '.btnCreateTask' ).on( 'click', function( e )
    {
        ...
        $.ajax({
            ...
            {
                if ( parseInt( taskId ) ) {
                    $( '#createTaskModalLabel' ).text( _Translator.trans( 'vs_issue_tracking.template.project_issues.edit_sub_task' ) );
                    $( '#btnCreateSubtask' ).text( _Translator.trans( 'vs_issue_tracking.template.project_issues.edit_sub_task' ) );
                } else {
                    $( '#createTaskModalLabel' ).text( _Translator.trans( 'vs_issue_tracking.template.project_issues.create_sub_task' ) );
    ...
    $( '#modalPipelineTask' ).on( 'click', '#btnCreateIssue', function( e )
    {
        ...
        $.ajax({
            ...
            success: function( response )
            {
                $( '#createTaskModalLabel' ).text( _Translator.trans( 'vs_application.template.project_issues.create_issue' ) );
                $( '#modalPipelineTask' ).html( response );
