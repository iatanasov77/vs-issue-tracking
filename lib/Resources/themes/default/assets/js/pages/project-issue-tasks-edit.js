        ...
        $.ajax({
            ...
            success: function( response )
            {
                let modalTitle  = taskId == '0' ?
                                    _Translator.trans( 'vs_issue_tracking.template.project_issues.create_issue_task_modal_title' ) :
                                    _Translator.trans( 'vs_issue_tracking.template.project_issues.edit_issue_task_modal_title' );
