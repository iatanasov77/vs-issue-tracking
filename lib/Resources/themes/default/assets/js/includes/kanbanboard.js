...
{
    var url = VsPath( 'vs_issue_tracking_project_issues_kanbanboard_task_move', {'taskId': taskId, 'pipelineId': pipelineId } );
    //alert( url ); return;
...
export function saveAttachment()
{
    ...
    var redirectUrl = VsPath( 'vs_issue_tracking_project_issues_kanbanboard_task_show', {'taskId': $( '#FileOwnerId' ).val() } );
